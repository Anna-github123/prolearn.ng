...
function initialise_fullme_cli() {
    ...
    if (defined('APS_SCRIPT')) {
        // prevent error
        //Default exception handler: Sorry, but you do not currently have permissions to do that (Manage models) Debug:
        //Error code: nopermissions
        //* line 810 of /lib/accesslib.php: required_capability_exception thrown
