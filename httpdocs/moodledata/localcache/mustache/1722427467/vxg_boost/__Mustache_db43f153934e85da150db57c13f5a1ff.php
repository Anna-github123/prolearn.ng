...
class __Mustache_db43f153934e85da150db57c13f5a1ff extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section541aad6f0b25d697660dcdeb08cfe00d($context, $indent, $value);
        $value = $context->find('logourl');
        if (empty($value)) {
            
            $buffer .= $indent . '            <h1 class="h2 card-header text-center" aria-label="';
...
';
        ...
        $buffer .= $this->section9560dce91b418ef2e587b67badab9ea6($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('hasidentityproviders');
        $buffer .= $this->sectionDdd03e9545a9123e15151668640e9875($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '            </div>
';
...
';
        ...
        $buffer .= $this->section8ae951adee56168b80983810bc564d2d($context, $indent, $value);
    ...
    private function section541aad6f0b25d697660dcdeb08cfe00d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9560dce91b418ef2e587b67badab9ea6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                                <button class="btn btn-secondary btn-block" type="submit" id="loginguestbtn">';
                $value = $context->find('str');
...
';
    ...
    private function sectionDe5a6e3a3f6153841e3a8a848a7a3711(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <div class="potentialidp">
                                <a href="{{url}}" title="{{name}}" class="btn btn-secondary btn-block">
                                    {{#iconurl}}
                                        <img src="{{iconurl}}" alt="" width="24" height="24"/>
                                    {{/iconurl}}
                                    {{name}}
...
';
    ...
    private function sectionDdd03e9545a9123e15151668640e9875(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionDe5a6e3a3f6153841e3a8a848a7a3711($context, $indent, $value);
                $buffer .= $indent . '                    </div>
';
                $context->pop();
            }
...
';
    ...
    private function section8ae951adee56168b80983810bc564d2d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
